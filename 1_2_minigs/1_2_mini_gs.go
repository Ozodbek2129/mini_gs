...
type Minigs12Struct struct {
	Key   string `json:"key"`
	Value int64  `json:"value"`
}

var filename = "minigs12.json"
...
func Minigs12Post(c *gin.Context) {

	var data Minigs12Struct
...
func Minigs12Read(c *gin.Context) {
...
func StartFileWatcher_minigs12() {
	var err error
...
func WebSocketHandler_minigs12(c *gin.Context) {
