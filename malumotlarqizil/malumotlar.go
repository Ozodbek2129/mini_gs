...
func NewMalumotlarRepoqizil(DB *sql.DB) *MalumotlarStruct {
	return &MalumotlarStruct{
		db: DB,
	}
}

type MalumotlarStruct1qizil struct {
...
func (m *MalumotlarStruct) MalumotlarPostqizil(c *gin.Context) {
	query := `insert into malumotlarqizil (
										id, malumotlar_name, malumotlar_value, date, timee, created_at, update_at
									) values (
									 	$1, $2, $3, $4, $5, $6, $7)`

	var data MalumotlarStruct1qizil
...
func (m *MalumotlarStruct) MalumotlarGetqizil(c *gin.Context) {
	...
	var datas []resultqizil
	for rows.Next() {
		var data resultqizil
